 ...
 * arguments:
 * customer_details
 * module: customers function: modify
 */
...
function modify_customer($customer_details) {
    $url = geturl("customers", "modify", $customer_details);
    $json = getjson($url);
...
echo modify_customer($customer_details);
